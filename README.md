...
Chacune d’entre elle a conçu un modèle qui leur est propre. Ils se distinguent par la forme de leur flotteur semi-submersible et par la position du mat et des pâles. L’éolienne Windfloat développée par Principal Power possède, par exemple, une base flottante triangulaire. Les sommets, dont un supporte le mat, sont des piliers régulant automatiquement le niveau d’eau à l’intérieur de ces derniers. Cela, en fonction de la direction du vent et donc de la rotation du mat sur lui-même. Ce type d’éolienne est déjà en mer depuis (ANNEE) au large de (ZONE GEO) pour faire ses preuves, tandis qu’Eolink n’est qu’à l’état de prototype avec un modèle 1/10 en mer depuis (ANNEE) à (VILLE). Cette éolienne semble plus innovante puisque son mat est formé de quatre piliers reposants chacun sur un des sommets de la base carrée et se rejoignant en tipi. Les pâles sont donc disposées entre les piliers de sorte que l’éolienne possède un plan de symétrie ce qui permet une meilleure répartition des efforts. Enfin, l’éolienne Floatgen, développée par Ideol, présente une base flottante carrée avec un mat fixée sur l’un des côtés
